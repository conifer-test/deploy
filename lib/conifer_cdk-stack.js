...
class ConiferCdkStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const coniferTaskDefinition1 = new ecs.Ec2TaskDefinition(this, 'conifer-task-1', {
      family: 'coniferTask1'
    });
    coniferTaskDefinition1.addContainer('conifer-container-1', {
      image: ecs.ContainerImage.fromRegistry('ahmadjiha/cypress-realworld-app'),
      memoryLimitMiB: 7000,
      environment: { FILES_GLOB: "cypress/tests/api/*.spec.{js,jsx,ts,tsx}" }
    });
    ...
    coniferTaskDefinition2.addContainer('conifer-container-2', {
      image: ecs.ContainerImage.fromRegistry('ahmadjiha/cypress-realworld-app'),
      memoryLimitMiB: 7000,
      environment: { FILES_GLOB: "cypress/tests/demo/*.spec.{js,jsx,ts,tsx}"}
    });
    ...
    coniferTaskDefinition3.addContainer('conifer-container-3', {
      image: ecs.ContainerImage.fromRegistry('ahmadjiha/cypress-realworld-app'),
      memoryLimitMiB: 7000,
      environment: { FILES_GLOB: "cypress/tests/ui/*.spec.{js,jsx,ts,tsx}"}
    });
    ...
    coniferTaskDefinition4.addContainer('conifer-container-4', {
      image: ecs.ContainerImage.fromRegistry('ahmadjiha/cypress-realworld-app'),
      memoryLimitMiB: 7000,
      environment: { FILES_GLOB: "cypress/tests/ui-auth-providers/*.spec.{js,jsx,ts,tsx}"}
    });
    ...
    // s3Bucket.grantReadWrite(imRole);
